...
const SearchBar = () => {
  return (
    <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 bg-gray-950">
      <div className="relative isolate overflow-hidden bg-gray-950 px-6 py-20 text-center sm:px-16 sm:shadow-sm mt-32">
        ...
        <form action="/search">
          ...
          >
            <input
              id="search-bar"
              placeholder="Search with HyperCube..."
              name="q"
              className=" text-lime-400 px-6 py-2 w-full rounded-md flex-1 outline-none bg-gray-800 placeholder-lime-400"
            />
            <button
              type="submit"
